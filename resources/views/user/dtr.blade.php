  ...
  <div class="col-8">
    <div class="card">
      <div class="card-header">
        <h4>
          <button class="btn btn-sm btn-warning btn-fab btn-icon btn-round float-right" onclick="printThis('dtrPrint','{{ $attendances[0]->id }}','','3')"><i class="fa fa-print"></i></button>
        </h4>
      </div>
      <div class="card-body" id="dtrPrint">
        <table style="width: 100%">
          ...
          <tr>
            ...
            <td colspan="3">{{ $attendances[0]->emp_no }}</td>
            <td></td>
            <td><b>FOR THE PERIOD</b></td>
            <td colspan="3">
              @php
                $date = Carbon\Carbon::parse($attendances[0]->dtr_date);
              @endphp
          ...
          <tr>
            <td><b>NAME</b></td>
            <td colspan="3">{{ $attendances[0]->last_name }}, {{ $attendances[0]->first_name }} {{ $attendances[0]->middle_name[0] }}</td>
            <td></td>
            <td><b>POSITION</b></td>
            <td colspan="3">{{ $attendances[0]->position }}</td>
          </tr>
          <tr>
            <td><b>DEPARTMENT</b></td>
            <td colspan="3">{{ $attendances[0]->department }}</td>
            <td></td>
            <td><b>ACCOUNT NO.</b></td>
            <td colspan="3">{{ $attendances[0]->acct_no }}</td>
          </tr>
        </table>
